...
public class TestAutoGenerator {
	...
	private final String[] tableNames = "DailyCheckStat,Depart,Emp,MonthlyWage,Users,WageConfig,DepartmentManager,EmpMonthlyWage".split(",");
...
//		strategy.setInclude(tableNames);
		...
		// 设置逻辑删除键（这个是逻辑删除的操作）
		strategy.setLogicDeleteFieldName("LogicalDelete");
